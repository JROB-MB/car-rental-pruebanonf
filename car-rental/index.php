...
//         // Envía una respuesta al cliente para confirmar que se almacenó el ID del usuario en la sesión
//         header('Content-Type: application/json');
//         echo json_encode(array('message' => 'User ID stored in session'));
//         exit(); // Termina la ejecución después de enviar la respuesta
//     } else {
//         // En caso de error o datos incorrectos en la solicitud
